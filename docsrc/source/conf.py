...
html_baseurl = "https://nickderobertis.github.io/mirror-api" + '/'
...
html_theme_options = dict(
    nav_title=project,
    base_url="https://nickderobertis.github.io/mirror-api",
    color_primary='indigo',
    color_accent='deep-purple',
    logo_icon='&#xe869',
    repo_url="https://github.com/nickderobertis/mirror-api",
    repo_name="mirror-api",
    globaltoc_depth=3,
)
...
texinfo_documents = [
    (master_doc, conf.PACKAGE_NAME, f'{conf.PACKAGE_NAME} Documentation',
     author, conf.PACKAGE_NAME, "An API that returns the structure of the request as the response",
     'Miscellaneous'),
]
